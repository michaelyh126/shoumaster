  ...
  <div class="main">
    <a-form-model class="user-layout-login" @keyup.enter.native="handleSubmit">
      <a-tabs :activeKey="customActiveKey" :tabBarStyle="{ textAlign: 'center', borderBottom: 'unset' }"  @change="handleTabClick">
        ...
        <a-tab-pane key="tab2" tab="声纹登录">
          <login-voiceprint ef="vlogin" @validateFail="validateFail" @success="requestSuccess" @fail="requestFailed" ></login-voiceprint>
...
import LoginVoiceprint from "./third/LoginVoiceprint";
