  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="自增主键" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="aid">
              <a-input-number v-model="model.aid" placeholder="请输入自增主键" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="唯一识别id" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="openid">
              <a-input v-model="model.openid" placeholder="请输入唯一识别id"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="签到时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="signTime">
              <j-date placeholder="请选择签到时间"  v-model="model.signTime" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="异常" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="isException">
              <a-input v-model="model.isException" placeholder="请输入异常"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/student_records/studentRecords/add",
          edit: "/student_records/studentRecords/edit",
          queryById: "/student_records/studentRecords/queryById"
        }
      }
    },
    computed: {
